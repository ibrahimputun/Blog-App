...
const useBlogCalls = () => {
  ...
  const getMyBlog = async (id) => {
    ...
    try {
      const { data } = await axiosWithToken.get(
        `https://36140.fullstack.clarusway.com/blogs?author=${id}`
      );
  ...
  const postBlog = async (info) => {
    ...
    try {
      await axiosWithToken.post(
        "https://36140.fullstack.clarusway.com/blogs/",
        info
      );
  ...
  const deleteBlog = async (id, page) => {
    ...
    try {
      await axiosWithToken.delete(
        `https://36140.fullstack.clarusway.com/blogs/${id}`
      );
  ...
  const likeBlog = async (id ,page) => {
    ...
    try {
      await axiosWithToken.post(
        `https://36140.fullstack.clarusway.com/blogs/${id}/postLike`
      );
